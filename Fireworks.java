...
public class Fireworks implements Runnable
{
	...
	private	ThreadGroup	group = new ThreadGroup("Lab3.Fireworks");
	...
	/**
	 * Stops the fireworks display.  Lab3.Fireworks already fired are allowed to finish but no new
	...
	public void stop()
	{
		...
		catch (InterruptedException ie)
		{
			JOptionPane.showMessageDialog(panel, "Error stopping fireworks",
					"Lab3.Fireworks Error", JOptionPane.ERROR_MESSAGE);
		}
	}
